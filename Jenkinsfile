pipeline {
    ...
    environment {
        ...
        DOCKER_IMAGE = "jjsee/ecommerce:latest"
    }

    stages {
        stage('Git Checkout') {
            steps {
                git 'https://github.com/JayanthRajN/Ecommerce-App-Kastro.git'
            }
        }
        ...
        stage('Publish to Nexus') {
            steps {
                withMaven(globalMavenSettingsConfig: 'maven-setting', jdk: 'java21', maven: 'maven') {
